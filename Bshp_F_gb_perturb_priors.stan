...
int j;	
		...
		theta_a[1] ~ normal(0.05,0.5) T[-1,1];
		theta_a[2] ~ normal(0.0,0.5) T[-1,1];
		theta_a[3] ~ normal(0,0.5) T[-1,1];
		
		theta_b[1] ~ normal(0.75,0.5) T[0,2];
		theta_b[2] ~ normal(0.75,0.5) T[0,2];
		theta_b[3] ~ normal(0.75,0.5) T[0,2];

		theta_c[1] ~ normal(0.1,0.25) T[0,0.5];
		theta_c[2] ~ normal(0.1,0.25) T[0,0.5];
		theta_c[3] ~ normal(0.1,0.25) T[0,0.5];
		
		theta_A[1] ~ normal(0.3,0.25) T[0,1];
		theta_A[2] ~ normal(0.3,0.25) T[0,1];
		theta_A[3] ~ normal(0.3,0.25) T[0,1];

		theta_B[1] ~ normal(0.4,0.25) T[0,1];
		theta_B[2] ~ normal(0.4,0.25) T[0,1];
		theta_B[3] ~ normal(0.4,0.25) T[0,1];

		theta_C[1] ~ normal(0.1,0.1) T[0,0.5];
		theta_C[2] ~ normal(0.1,0.1) T[0,0.5];
		theta_C[3] ~ normal(0.1,0.1) T[0,0.5];
		
		sd_a[1] ~ normal(0.5,0.5)T[0,1];
		sd_a[2] ~ normal(0.5,0.5)T[0,1];
		sd_a[3] ~ normal(0.5,0.5)T[0,1];		
		
		sd_b[1] ~ normal(0.5,0.5)T[0,1];
		sd_b[2] ~ normal(0.5,0.5)T[0,1];
		sd_b[3] ~ normal(0.5,0.5)T[0,1];
		
		sd_c[1] ~ normal(0.1,0.05)T[0,0.25];
		sd_c[2] ~ normal(0.1,0.05)T[0,0.25];
		sd_c[3] ~ normal(0.1,0.05)T[0,0.25];
		
		sd_A[1] ~ normal(0.1,0.05)T[0,0.25];
		sd_A[2] ~ normal(0.1,0.05)T[0,0.25];
		sd_A[3] ~ normal(0.1,0.05)T[0,0.25];
		

		sd_B[1] ~ normal(0.1,0.05)T[0,0.25];
		sd_B[2] ~ normal(0.1,0.05)T[0,0.25];
		sd_B[3] ~ normal(0.1,0.05)T[0,0.25];
